                    ...
                    <div class="col-12 col-md-4 mb-3">
                        <ul class="list-group">
                            ...
                            >
                                <span>Tipo:</span>
                                <strong>{{
                                    currentRent.room.category.description
                                }}</strong>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="list-group">
                            ...
                            >
                                ...
                                <strong
                                    ...
                                    {{
                                        currentRent.output_time | toTime
                                    }}</strong
                                >
                            </li>
                        </ul>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>
                                            {{
                                                it.item.input_unit_price_value
                                                    | toDecimals
                                            }}
                                        </td>
                                        <td>
                                            {{ it.item.quantity | toDecimals }}
                                        </td>
                                        <td>
                                            {{
                    ...
                    <div class="col-12 pt-3">
                        <template v-if="canMakePayment">
                            ...
                            >
                                ...
                                <span class="ml-2"
                                    >Guardar y Generar Comprobante</span
                                >
                            </el-button>
                        </template>
                        <template v-else>
...
export default {
    ...
    async mounted() {
        ...
        this.room.item = await calculateRowItem(
            this.room.item,
            "PEN",
            3,
            this.percentage_igv
    ...
    watch: {
        arrears(value) {
            ...
            if (value >= 0) {
                this.room.item.total =
                    this.room.item.input_unit_price_value *
                    this.room.item.quantity;
                const total = this.room.item.total + parseFloat(value);
                this.total = total;
    ...
    methods: {
        ...
        onCalculatePaidAndDebts() {
            ...
            if (this.document.payments.length == 1) {
                this.document.payments[0].payment =
                    this.totalDebt + this.totalPaid;
            }
        },
        changeNigth() {
            this.room.item.total =
            ...
            const total = this.room.item.total + parseFloat(this.arrears || 0);
            this.total = total;
            this.onCalculatePaidAndDebts();
        },
        ...
        clickAddPayment() {
            ...
            */
            ...
            if (this.document.payments.length == 0) {
                payment =
                    this.totalDebt > 0 ? this.totalDebt : this.document.total;
            }
        ...
        onUpdateItemsWithExtras() {
            ...
            this.document.items = this.document.items.map((it) => {
                if (it.item_id === this.room.item_id) {
                    ...
                    it.quantity = 1;
                    const newTotal =
                        parseFloat(this.room.item.total) +
