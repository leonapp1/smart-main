        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                <template v-if="showClose">
                    ...
                    <el-button
                        v-if="generate && !form.has_document_sale_note"
                ...
                <template v-else>
                    ...
                    >
                    <el-button type="primary" @click="clickNew"
...
export default {
    ...
    methods: {
        ...
        async initTables() {
            await this.$http.get(`/generate-document/tables`).then(response => {
        ...
        async getRecord() {
            ...
            await this.$http
                ...
                .then(response => {
                    ...
                    // });
                    let { affectation_igv_type_id } = this.config;
                    this.getPercentageIgv();
                    let total = _.round(parseFloat(this.record.cost), 2);
                    let unit_value =
                        this.record.cost / (1 + this.percentage_igv / 100);
                    ...
                    this.form.items.forEach(row => {
                        ...
                        if (affectation_igv_type_id == "20") {
                            total_exonerated += row.total_value;
                        } else {
                    ...
                    this.form.total_exonerated = total_exonerated;
        ...
        onPrepareItems(items) {
            return items.map(i => {
                ...
                i.input_unit_price_value = i.has_igv
                    ? i.unit_value
                    : i.unit_price;
        ...
        async searchRemoteCustomers(input) {
            ...
            await this.$http
                .post(`/generate-document/customers`, {
                    input: input
                })
                .then(response => {
        ...
        async submit() {
            ...
            if (this.form.exchange_rate_sale === undefined) {
                this.form.exchange_rate_sale = this.exchange_rate;
            }
            await this.$http
                .post(`/generate-document`, this.form)
                .then(response => {
