...
class ToPay
{
    ...
    public static function getToPay($request)
    {
        ...
        $bills_of_exchanges_select = "bills_of_exchange_pay.id as id, " .
        ...
        /** Prestamos bancarios */
        if ($withBankLoan === 1) {
            $bankLoansPayments = DB::connection('tenant')->table('bank_loan_payments')
        ...
        $records->union($bills_of_exchange);
        if ($bankLoans !== null) {
