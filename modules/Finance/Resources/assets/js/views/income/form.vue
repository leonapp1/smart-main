                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div
                                class="form-group"
                                :class="{ 'has-danger': errors.income_type_id }"
                            >
                                ...
                                <small
                                    class="text-danger"
                                    v-if="errors.income_type_id"
                                    v-text="errors.income_type_id[0]"
                                ></small>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div
                                class="form-group"
                                :class="{
                                    'has-danger': errors.income_reason_id,
                                }"
                            >
                                <label class="control-label">Motivo</label>
                                <el-select v-model="form.income_reason_id">
                                    <el-option
                                        v-for="option in income_reasons"
                                        :key="option.id"
                                        :value="option.id"
                                        :label="option.description"
                                    ></el-option>
                                ...
                                <small
                                    class="text-danger"
                                    v-if="errors.income_reason_id"
                                    v-text="errors.income_reason_id[0]"
                                ></small>
                            </div>
                        </div>
                    </div>
    ...
    async created() {
        ...
        this.$http.get(`/${this.resource}/tables`).then((response) => {
            ...
            this.form.income_type_id =
                this.income_types.length > 0 ? this.income_types[0].id : null;
            this.form.income_reason_id =
                this.income_reasons.length > 0
                    ? this.income_reasons[0].id
                    : null;
