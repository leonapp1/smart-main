                    ...
                    <table class="table table-responsive-xl">
                        ...
                        <tbody>
                            <tr v-for="(row, index) in records" :key="index">
                                ...
                                <td class="text-center">
                                    {{ row.document_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ row.sale_note_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ row.quotation_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ row.contract_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{
                                ...
                                <td class="text-center">
                                    {{ row.income_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ row.purchase_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ row.expense_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ row.bank_loan | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ row.bank_loan_payment | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ row.balance | DecimalText }}
                                </td>
                                <td class="text-center">
                                    <el-button
                                        type="primary"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_documents | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_sale_notes | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_quotations | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_contracts | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{
                                        totals.t_technical_services
                                            | DecimalText
                                    }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_income | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_purchases | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_expenses | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_bank_loan | DecimalText }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{
                                        totals.t_bank_loan_payment | DecimalText
                                    }}
                                </td>
                                <td class="text-center">
                                    {{ curencySymbol }}
                                    {{ totals.t_balance | DecimalText }}
                                </td>
                            </tr>
                        </tfoot>
                    </table>
    ...
    methods: {
        async showDetail(row) {
            ...
            let form = {
                ...
                console.log("🚀 ~ showDetail ~ form:", form)
            let params = queryString.stringify({
                ...form,
            });
        
            window.open(`/${this.resource}/detail?${params}`, "_blank");
        },
