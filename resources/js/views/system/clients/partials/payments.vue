                            ...
                            <tbody>
                                ...
                                >
                                    <template v-if="row.id">
                                        ...
                                        <td v-if="row.card_brand">
                                            {{ row.card_brand.description }}
                                        </td>
                                        <td v-else>-</td>
                                        <td>{{ row.reference }}</td>
                                        <td>S/ {{ row.payment }}</td>
                                        ...
                                        <td>
                                            <template v-if="row.payment_file">
                                                <a
                                    ...
                                    <template v-else>
                                        ...
                                        <td v-if="has_card">
                                            <div
                                                ...
                                                :class="{
                                                    'has-danger':
                                                        row.errors.card_brand_id
                                                }"
                                            >
                                                <el-select
                                                    v-model="row.card_brand_id"
                                                >
                                                    <el-option
                                                        v-for="option in card_brands"
                                                        :key="option.id"
                                                        :value="option.id"
                                                        :label="
                                                            option.description
...
export default {
    ...
    methods: {
            ...
            if (conf) {
                try {
                    ...
                    const response = await this.$http.delete(
                        `/client_payments/delete_file/${id}`
                    );
        ...
        beforeUpload(file) {
            ...
            let pass = false;
            //valid extension  .png .jpg .jpeg .pdf
            ...
            if (
                ...
                this.$message({
                    type: "error",
                    message: "El archivo debe ser de tipo .png .jpg .jpeg .pdf"
                });
            }
        ...
        async clickCancelPayment(client_payment_id) {
            await this.$http
                .get(`/${this.resource}/cancel_payment/${client_payment_id}`)
                .then(response => {
                    if (response.data.success) {
                        this.$message.success(response.data.message);
                        this.getData();
