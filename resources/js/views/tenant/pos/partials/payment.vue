            ...
            <div class="h-60 bg-white" style="overflow-y: auto">
                <div class="row pl-3 pt-3 border-bottom m-0 p-0 bg-white">
                    <div class="col-12 px-0">
                        <h6 class="font-weight-semibold m-0 text-secondary">
                ...
                <template v-for="(item, index) in form.items">
                    ...
                    >
                        <div class="col-2 p-r-0 m-l-2">
                            <small
                                class="font-weight-semibold m-0 text-secondary"
                                >{{ item.quantity }}</small
                            >
                        </div>
                        ...
                        <div class="col-4 p-l-0">
                            ...
                            <small
                                class="font-weight-semibold m-0 text-end text-secondary"
                            >
            ...
            <div class="h-40 bg-info" style="overflow-y: auto">
                ...
                >
                    <div class="col-lg-6">
                        <button
                            :disabled="
                                button_payment && payment_method_type_id != '09'
                            "
