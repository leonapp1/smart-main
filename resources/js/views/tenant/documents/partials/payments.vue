                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr v-for="(row, index) in records" :key="index">
                                ...
                                <template  v-if="external">
                                    <td class="series-table-actions text-center">
                                        <button type="button" class="btn waves-effect waves-light btn-sm btn-primary" @click.prevent="clickOptionsPrint()"><i class="fas fa-file-upload"></i></button>
                                    </td>
                                </template>
                            ...
                            <tr v-if="document.credit_notes_total">
                                <td colspan="6" class="text-end">TOTAL NOTA CRÉDITO</td>
                                <td class="text-end">{{ document.credit_notes_total }}</td>
                            </tr>
                            <tr>
