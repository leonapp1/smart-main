...
export default {
    ...
    methods: {
        ...
        async onFetchNoteItems() {
            ...
            const data = {
                purchases_id: this.form.selecteds,
                customer_id: this.form.client_id,
                date_of_due: this.form.date_of_due,
            };
            try {
                await this.$http.post("/bill-of-exchange-pay", data);
                this.form.selecteds = [];
                this.notes = [];
                this.onClose();
        ...
        onFindNotes() {
            ...
            this.$http
                .get(`/bill-of-exchange-pay/list-by-client`, { params })
                .then((response) => {
