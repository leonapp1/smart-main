    ...
    <table class="full-width mt-10 mb-10">
        ...
        */
            ...
            @if ($document->total_exportation > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Op. Exportación:
            ...
            @if ($document->total_free > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Op. Gratuitas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_unaffected > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Op. Inafectas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_exonerated > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Op. Exoneradas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_taxed > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Op. Gravadas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_discount > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">
            ...
            @if ($document->total_plastic_bag_taxes > 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Icbper:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-right font-bold">{{ number_format($document->total_plastic_bag_taxes, 2) }}</td>
                </tr>
            @endif
            <tr>
                <td colspan="{{ $colspan_totals }}" class="text-right font-bold">IGV:
                    {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->perception)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold"> Importe total:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-right font-bold">{{ number_format($document->total, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Percepción:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-right font-bold">{{ number_format($document->perception->amount, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Total a pagar:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($balance < 0)
                <tr>
                    <td colspan="{{ $colspan_totals }}" class="text-right font-bold">Vuelto:
                        {{ $document->currency_type->symbol }}</td>
