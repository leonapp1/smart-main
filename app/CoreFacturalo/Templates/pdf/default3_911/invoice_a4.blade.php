...
<body>
    ...
    <div class="item_watermark" style="position: absolute; text-align: center; top:20%;">
        <img height="100%" src="{!! $waterMark64 !!}" style="opacity: 0.2;width: 95%">
    </div>
    ...
    <table class="full-width mt-10 mb-10">
        <thead class="">
            <tr class="bg-grey">
                <th class="border-top-bottom text-center py-2" width="8%">COD.
                </th>
                <th class="border-top-bottom text-center py-2" width="8%">Cant.
                </th>
                <th class="border-top-bottom text-center py-2" width="8%">Unidad
                </th>
                <th class="border-top-bottom text-left py-2">Descripción</th>
                <th class="border-top-bottom text-center py-2" width="8%">Lote
                </th>
                <th class="border-top-bottom text-center py-2" width="8%">Serie
                </th>
                <th class="border-top-bottom text-right py-2" width="12%">V.UNIT
                </th>
                <th class="border-top-bottom text-right py-2" width="12%">P.Unit
                </th>
                <th class="border-top-bottom text-right py-2" width="8%">Dto.
                </th>
                <th class="border-top-bottom text-right py-2" width="12%">TOTAL
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td colspan="9" class="text-right font-bold">{{(($document->total_prepayment > 0) ? 'Anticipo':'Descuento TOTAL')}}
        ...
        <tr>
            <td width="65%" style="text-align: top; vertical-align: top;">
                ...
                <p style="text-transform: uppercase;">Son:
                    <span class="font-bold">{{ $row->value }} {{ $document->currency_type->description }}</span>
                </p>
    ...
    <table class="full-width border-box my-2">
        <tr>
            <th class="p-1" width="25%">Banco
            </th>
            <th class="p-1">Moneda</th>
            <th class="p-1" width="30%">Código de Cuenta Interbancaria
            </th>
            <th class="p-1" width="25%">Código de Cuenta
            </th>
        </tr>
        @foreach($accounts as $account)
        <tr>
