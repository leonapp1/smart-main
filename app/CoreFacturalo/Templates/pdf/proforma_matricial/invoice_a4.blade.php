...
<body>
    ...
    <table class="full-width mt-3">
        ...
        <tr>
            ...
            <td width="8px">:</td>
            <td>
                {{ $document->quotation->identifier }}<br>
            </td>
        ...
        @endif
        @if ($document->quotations_optional!=null && $document->quotations_optional_value)
        <tr>
            <td width="120px">{{$document->quotations_optional}} </td>
            <td width="8px">:</td>
            <td colspan="3">
