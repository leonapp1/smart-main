...
<table class="full-width mt-10 mb-10">
    ...
    <tr>
        ...
        <th class="border-top-bottom desc text-right">V.unit</th>
    ...
    @foreach($document->items as $row)
        <tr>
            ...
            <td  class="text-right align-top desc ">{{ number_format($row->unit_value, 2) }}</td>
            <td  class="text-right align-top desc ">{{ number_format($row->total_value, 2) }}</td>
        </tr>
        <tr>
