...
<body>
    ...
    <table class="full-width mt-10 mb-10">
        <thead class="">
            <tr class="bg-grey">
                <th class="border-top-bottom text-center py-2" width="8%">It.</th>
                <th class="border-top-bottom text-center py-2" width="8%">Codigo</th>
                <th class="border-top-bottom text-left py-2">Descripción</th>
                <th class="border-top-bottom text-center py-2" width="8%">Unidad</th>
                <th class="border-top-bottom text-center py-2" width="8%">Cant.</th>
                <th class="border-top-bottom text-center py-2" width="8%">Bultos</th>
                    ...
                    <td class="text-left align-top">
                        @if ($row->name_product_pdf)
                            ...
                            @php
                                ...
                                $row->name_product_pdf = str_replace('<p>', '', $row->name_product_pdf);
                                $row->name_product_pdf = str_replace('</p>', '', $row->name_product_pdf);
                            @endphp
                        ...
                        @endif
                        @if (isset($row->item->meter) && $row->item->meter > 0)
                            <br /><span style="font-size: 9px">Mts : {{ $row->item->meter }}</span>
                        @endif
                        @if ($row->total_isc > 0)
                    ...
                    @else
                        <td class="text-right align-top">
                            @php
                                ...
                                if (isset($row->item->meter) && $row->item->meter > 0) {
                                    $unit_price = $row->unit_price / $row->item->meter;
                                }
                            @endphp
